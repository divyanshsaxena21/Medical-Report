...
const Analysis = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setPrediction(data.prediction || data.result || "Analysis completed")
    } catch (err) {
  ...
  const getPredictionColor = (pred) => {
    ...
    if (prediction.includes("normal")) return "from-green-500 to-green-600"
    if (prediction.includes("covid")) return "from-red-500 to-red-600"
    if (prediction.includes("pneumonia")) return "from-blue-500 to-blue-600"
    if (prediction.includes("tuberculosis")) return "from-yellow-500 to-yellow-600"
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-2">X-ray Analysis</h1>
          <p className="text-xl text-gray-600">Upload your chest X-ray image for AI-powered medical analysis</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="space-y-6">
            <div className="bg-white rounded-2xl shadow-xl p-6">
              ...
              <p className="text-gray-600 mb-6">Supported formats: JPG, PNG, JPEG (Max size: 10MB)</p>
              ...
              >
                ...
                <h3 className="text-lg font-semibold text-gray-700 mb-2">Drop your X-ray image here</h3>
          ...
          <div className="space-y-6">
            {previewUrl && (
              <div className="bg-white rounded-2xl shadow-xl p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Image Preview</h3>
            ...
            {prediction && !loading && (
              <ResultCard prediction={prediction} gradientColor={getPredictionColor(prediction)} />
            )}
          </div>
        </div>
